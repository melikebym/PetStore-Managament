...
namespace PetShop
{
    public partial class UserBillings1 : Form
    {
        public UserBillings1()
        {
            InitializeComponent();
            GetCustomers();
            DisplayProduct();
        ...
        private void CustIdCb_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            GetCustName();
        ...
        private void ResetTb_Click_1(object sender, EventArgs e)
        {

        }

        private void AddTb_Click_1(object sender, EventArgs e)
        {
            if (QtyTb.Text == "" || Convert.ToInt32(QtyTb.Text) > Stock)
            {
                MessageBox.Show("Yeterli Stok Bulunmamakta!");
            }
